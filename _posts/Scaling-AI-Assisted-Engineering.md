---
title: 'Scaling AI-Assisted Engineering'
...
ogImage:
  url: '/assets/blog/Scaling-AI-Assisted-Engineering/cover.jpg'
---
...
We have moved from copilots, which were reactive and required constant prompting, to agentic workflows. Tools like the [Gemini CLI](https://geminicli.com/) are no longer just assistants; they are digital colleagues that persist through the entire software development lifecycle.
...
To see how we are building the foundation for this future today, read my previous deep dives on building [custom agent skills](https://medium.com/@fhinkel/beyond-the-prompt-building-agentic-workflows-with-gemini-cli-skills-34ed4f466b7e) and [managing project context with Conductor](https://medium.com/@fhinkel/scaling-ai-assisted-engineering-with-conductor-1eade067d8f9).
